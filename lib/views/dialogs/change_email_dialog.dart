...
class _ChangeEmailDialogState extends State<ChangeEmailDialog> {
  ...
  void onSave(BuildContext context) async {
    ...
    try {
      await user.changeEmail(_newEmailController.text);
      ...
      _errors.addAll({"subtext": "Alas, the email can't be changed. Try another day"});
    }
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(18.0),
              child: Text('Change email', style: TextTheme.of(context).titleLarge),
            ),
            Divider(),
            Container(
              width: 400,
              child: Column(
                children: [
                  Padding(
                    ...
                    child: TextField(decoration: InputDecoration(label: Text("New email"), errorText: _errors["email"]), controller: _newEmailController),
                  ),
                  Padding(
                      padding: const EdgeInsets.all(5.0),
